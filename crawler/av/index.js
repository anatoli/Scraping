    ...
    var q = tress(function (url, callback) {
        ...
        needle.get(url, function (err, res) {
            ...
            options.each(function (each_index) {
                ...
                var models_str_array = model_array.body.split('\n');
                ...
                if(each_index === options.length-1 ) {
                    fs.writeFileSync('./av/cars_model_id.json', JSON.stringify(models, null, 4));
